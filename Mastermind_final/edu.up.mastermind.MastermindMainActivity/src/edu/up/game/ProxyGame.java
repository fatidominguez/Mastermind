...
//            }
     ...
     * 
     */
    private void setState(LocalGame state) {
     ...
     *  requested
     */
    public LocalGame getState(GamePlayer p, int stateType) {
        if (p != player) {
...
//        }
     ...
     */
    protected abstract LocalGame decodeState(String str);
